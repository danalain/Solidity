...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "Your shares cannot be distributed now.");
        
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares, "Distributed shares must be less than the total shares!");

        // 365 days to the `unlock_time`
